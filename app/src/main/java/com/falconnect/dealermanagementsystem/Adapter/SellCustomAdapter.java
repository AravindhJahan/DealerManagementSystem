...
public class SellCustomAdapter extends RecyclerView.Adapter<SellCustomAdapter.MyViewHolder> {
    ...
    private ArrayList<SellDataModel> selldataSet;
    private Context mContext;

    public SellCustomAdapter(Context context, ArrayList<SellDataModel> selldata) {
    ...
    public void onBindViewHolder(final MyViewHolder holder, final int listPosition) {
        ...
        final SellDataModel sell_singleItem = selldataSet.get(listPosition);
